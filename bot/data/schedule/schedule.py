from bot.data.schedule.base_model import dict_schedule_weekday, ScheduleWeekday, ScheduleToday, double_weekday, \
    weekday_list, dict_time_pupil, key_list, value_list
